    ...
    array (
      ...
      array (
        ...
        array (
          ...
          5 => 
          array (
            'customCode' => '<input  type="submit" class="button" name="create" id="create" value="Create Call" onClick="document.location=\'index.php?module=Calls&action=EditView&return_module=Calls&return_action=DetailView\'">',
          ),
        ),
        'hidden' => 
        array (
