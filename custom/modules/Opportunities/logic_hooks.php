...
$hook_array['after_save'] = Array();
$hook_array['after_save'][] = Array(1, 'Update description', 'custom/modules/Opportunities/update_description_opportunity.php','UpdateDescriptionOpportunity', 'updateDescriptionFunctionOpportunity'); 
$hook_array['after_save'][] = Array(79, 'updateFields', 'custom/modules/Opportunities/UpdateFieldsLogicHook.php','OpportunitiesUpdateFields', 'updateFields'); 
