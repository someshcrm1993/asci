...
class AOS_QuotesSugarpdfinvoice extends Sugarpdf
{
    /**
     * Override
     */
    ...
    function display()
    {
        ...
        $headerData = <<<EOD
          ...
          <tr><td align="center" style="font-size:26px">Phone: +91-40-66534247, Tele. Fax: +91-40- 66534356</td></tr>
          <tr><td align="center" style="font-size:26px">e-mail : poffice@asci.org.in</td></tr>
          </table>
EOD;
        ...
        $invoice = BeanFactory::getBean('AOS_Quotes', $record_id);
        $programme = $invoice->get_linked_beans('project_aos_quotes_1','AOS_Quotes');
        ...
        $invoice_date = $invoice->proforma_invoice_date_c;
        $pan_c = $invoice->pan_c;
        ...
        $project_aos_quotes_1_name = $invoice->project_aos_quotes_1_name;
        ...
        // $subtotal_amount = money_format('%!n',str_replace(',','',number_format((float)$invoice->subtotal_tax_amount,2)));
        $subtotal_amount = money_format('%!.0n',round($invoice->subtotal_tax_amount))."&nbsp;";
        ...
        // $discount_amount = money_format('%!n',str_replace(',','',number_format((float)$invoice->discount_amount,2)));
...
// print_r(ucwords($this->getIndianCurrency(floatval(str_replace(',', '', $am)))));exit;
        ...
        $igst_rate = 18;
        $ugst_rate = 9;
        if($invoice->proforma_stage_c == 'Approved by PO' || $invoice->proforma_stage_c == 'Proforma sent to client' || $invoice->proforma_stage_c == 'Ready to invoice' || $invoice->proforma_stage_c == 'Closed for updates' || $invoice->proforma_stage_c == 'Cancelled'){
            $signature = '<img width="50" src="custom/modules/AOS_Quotes/sugarpdf/PO G Srinivas Yadav Sign.jpeg"></img>';
        }else{
            $signature = '';
        }
		/* Added by ashvin
