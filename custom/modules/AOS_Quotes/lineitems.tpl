{*******************************************
	...
	@author: 		Rathina Ganesh, Aditya Harshey
	@date: 			27th May 2017
********************************************}
{if $view eq 'EditView'}
{literal}
...
// 	var igst = 0;
// 	var total_amount = 0;
// 	var programme_fee = parseFloat((a = $('#programme_fee_c').val().replace(/,/g,'')) == ''? 0: a);
// 	var programme_fee_non_res = parseFloat((a = $('#programme_fee_non_res_c').val().replace(/,/g,'')) == ''? 0: a);
// 	var accommodation = parseFloat((a = $('#accommodation_c').val().replace(/,/g,'')) == ''? 0: a);
// 	var living_allowance = parseFloat((a = $('#living_allowance_c').val().replace(/,/g,'')) == ''? 0: a);
// 	var other_reimbursement = parseFloat((a = $('#other_reimbursement_c').val().replace(/,/g,'')) == ''? 0: a);
// 	var discount_in_per_c = $('#discount_in_per_c').val().replace(/,/g,'');
// 	var discount_amount = 0;
// 	var npp = 0;

// 	// total_amt = programme_fee * $('#no_of_participants_c').val().replace(/,/g,'');

	
// 	total_amt = parseFloat($('#total_amt').val().replace(/,/g,''));
...
// 	var subtotal_amount = $('#subtotal_tax_amount').val().replace(/,/g,'');	
...
// 	// if ($('#billing_address_state').val().replace(/,/g,'').indexOf('Telangana') !== -1) {
// 	// 	$('#cgst_c').val(parseFloat(cgst).toFixed(2));
// 	// 	$('#sgst_c').val(parseFloat(sgst).toFixed(2));		
// 	// 	$('#igst_c').val(0);
// 	// }else{
// 	$('#cgst_c').val(parseFloat(cgst).toLocaleString('en-IN',{ maximumFractionDigits: 2 }));
// 	$('#sgst_c').val(parseFloat(sgst).toLocaleString('en-IN',{ maximumFractionDigits: 2 }));		
// 	$('#ugst_c').val(parseFloat(ugst).toLocaleString('en-IN',{ maximumFractionDigits: 2 }));		

// 	if ($('#igst_c').val().replace(/,/g,'') == '') {
// 		if ($('#billing_address_state').val().indexOf('Telangana') !== -1) {
// 			igst = parseFloat(cgst) + parseFloat(sgst);
// 		}
// 	}

// 	$('#igst_c').val(parseFloat(igst).toLocaleString('en-IN',{ maximumFractionDigits: 2 }));
	
// 	$('#tax_amount').val(parseFloat(tax_amount).toLocaleString('en-IN',{ maximumFractionDigits: 2 }));
// 	$('#total_amount').val(parseFloat(total_amount).toLocaleString('en-IN',{ maximumFractionDigits: 2 }));	
// }

// $('#no_of_participants_c,#total_amt, #discount_in_per_c, #discount_amount, #tax_type_c').on('blur change',function(){
