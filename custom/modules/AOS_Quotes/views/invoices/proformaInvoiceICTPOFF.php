...
<style type="text/css">
	...
	<div class="Section1">
    	<div class="MsoNormal">
    		...
    		<div>
    			<strong><u>PROFORMA INVOICE FOR ICTP OFF<br>CAMPUS (IN INR)</u></strong>
    		</div>
    		<br>
    		<div>
	    		<table cellspacing="0" cellpadding="0" border="0" height ="50cm">
	    			<tbody>
	    				...
	    				<tr>
	    					<td>4.</td>
	    					<td>Fee per day Rs.”Amount” for minimum of 25 participants </td>
	    					<td><?php echo $proformaInvoiceBean->programme_fee_c; ?></td>
	    				</tr>    	
	    				<tr>
	    					<td>5.</td>
	    					<td align="" width="300">Service Tax on the above @(Applicable Rate)</td>
	    					<td><?php echo $proformaInvoiceBean->tax_amount; ?></td>
	    				</tr>    				    			
	    				<tr>
	    					<td>6.</td>
	    					<td align="" width="300">Swachh Bharat Cess @(Applicable R e)at</td>
	    					<td><?php echo $proformaInvoiceBean->tax_amount; ?></td>
	    				</tr>  
	    				<tr>
	    					<td>7.</td>
	    					<td align="" width="300">Krishi Kalyan Cess @(Applicable Rate)</td>
	    					<td><?php echo $proformaInvoiceBean->tax_amount; ?></td>
	    				</tr>    
	    				<tr>
	    					<td></td>
	    				...
	    				<tr>
	    					<td></td>
	    					<td align="right"> </td>
	    					<td>Reimbursement of the faculty Airfare, Local travel and Stay expenses may please be added as per the actuals</td>
	    				</tr>    	
	    				<tr>
	    					<td>8.</td>
