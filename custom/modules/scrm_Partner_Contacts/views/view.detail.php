...
class scrm_Partner_ContactsViewDetail extends ViewDetail {


 	function scrm_Partner_ContactsViewDetail(){
 		parent::ViewDetail();
 	}
  ...
  <script>
        $(document).ready(function(){
			//alert('Hai');
			$('td[field="phone_mobile"]').append('<img src=\"custom/include/images/mob3.png\" title=\"Click here to Send SMS for the Contact\" class="smsimage" style=\" width:10px;height:17px;\" ></img>');
			
					
				$('td[field="phone_mobile"]').click(function(){
