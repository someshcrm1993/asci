...
$hook_array['before_save'][] = Array(2, 'update year', 'custom/modules/Leads/updateyear.php','updateyear', 'updateyearfunc' );
...
// $hook_array['after_save'][] = Array(2, 'Lead_Partner', 'custom/modules/Leads/lead_partner.php','Lead_Partner', 'lead_id_partner' );

$hook_array['after_save'] = Array();
$hook_array['after_save'][] = Array(1, 'Update description', 'custom/modules/Leads/update_description_lead.php','UpdateDescriptionLead', 'updateDescriptionFunctionLead'); 
?>
