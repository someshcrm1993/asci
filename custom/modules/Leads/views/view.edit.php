...
class LeadsViewEdit extends ViewEdit
{
    ...
    function display()
    {
    	...
    	if(empty($this->bean->id)){
    		$programme = BeanFactory::getBean('Project',$_REQUEST['project_leads_1project_ida']);
		...
		<script>
			$(document).ready(function(){
				...
				addToValidate('EditView','project_leads_1_name','project_leads_1_name',true,'Programme Title');
			});
		</script>
EOD;
		parent::display();
