    ...
    array (
      ...
      array (
        ...
        array (
          ...
          array (
              'customCode' => '<input  type="submit" class="button" name="create" id="create" value="Create Campaign" onClick="document.location=\'index.php?module=Campaigns&action=EditView&return_module=Campaigns&return_action=DetailView\'">',
            ),
        ),
        'links' => 
        array (
          ...
          3 => '<input id="printMailinglLabel" type="button" class="button" onclick="javascript:window.location=\'index.php?module=Campaigns&action=printMailingLabel&record={$fields.id.value}\';" name="button" value="Print Mailing Label" />',
        ),
      ),
      'maxColumns' => '2',
      'widths' => 
