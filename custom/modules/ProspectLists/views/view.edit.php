...
class ProspectListsViewEdit extends ViewEdit
{
 	
 	function ProspectListsViewEdit(){
 		parent::ViewEdit();
    ...
    function display()
    {
        echo '<div id = "dialog" title= "Warning!!!" style="display:none"><p>*Target list with duplicate name!</p></div>';
                ...
                $(document).on('blur','#name',function(){
                    setTimeout(function(){
                        ...
                        $.ajax({
                          ...
                          data: {title:$('#name').val(), type:"getTargetListName"}
                        }).success(function(rsp){
                            rsp = JSON.parse(rsp);
                             
                            if(rsp.Success == true){
                                if(rsp.data.name == true){
