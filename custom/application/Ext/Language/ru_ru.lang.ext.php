...
$app_list_strings['moduleList']['scrm_Feedback'] = 'Feedback';
$app_list_strings['scrm_feedback_category_dom'][''] = '';
$app_list_strings['scrm_feedback_category_dom']['Marketing'] = 'Маркетинг';
$app_list_strings['scrm_feedback_category_dom']['Knowledege Base'] = 'База знаний';
$app_list_strings['scrm_feedback_category_dom']['Sales'] = 'Продажи';
$app_list_strings['scrm_feedback_subcategory_dom'][''] = '';
$app_list_strings['scrm_feedback_subcategory_dom']['Marketing Collateral'] = 'Маркетинг';
$app_list_strings['scrm_feedback_subcategory_dom']['Product Brochures'] = 'Брошюры товаров';
$app_list_strings['scrm_feedback_subcategory_dom']['FAQ'] = 'ЧаВо';
$app_list_strings['scrm_feedback_status_dom']['Active'] = 'Активен';
$app_list_strings['scrm_feedback_status_dom']['Draft'] = 'Черновик';
$app_list_strings['scrm_feedback_status_dom']['FAQ'] = 'ЧаВо';
$app_list_strings['scrm_feedback_status_dom']['Expired'] = 'Просрочен';
$app_list_strings['scrm_feedback_status_dom']['Under Review'] = 'Рассматривается';
$app_list_strings['scrm_feedback_status_dom']['Pending'] = 'Ожидание решения';
...
$app_list_strings['record_type_display']['scrm_Work_Order'] = 'Work Order';
$app_list_strings['parent_type_display']['scrm_Work_Order'] = 'Work Order';
$app_list_strings['record_type_display_notes']['scrm_Work_Order'] = 'Work Order';
...
$app_list_strings['scrm_partners_type_dom']['Provider'] = 'Поставщик';
$app_list_strings['scrm_partners_type_dom']['Delivery service'] = 'Служба доставки';
$app_list_strings['scrm_partners_type_dom'][''] = '';
$app_list_strings['scrm_partners_type_dom']['Analyst'] = 'Аналитик';
$app_list_strings['scrm_partners_type_dom']['Competitor'] = 'Конкурент';
$app_list_strings['scrm_partners_type_dom']['Customer'] = 'Клиент';
$app_list_strings['scrm_partners_type_dom']['Integrator'] = 'Интегратор';
$app_list_strings['scrm_partners_type_dom']['Investor'] = 'Инвестор';
$app_list_strings['scrm_partners_type_dom']['Partner'] = 'Партнер';
$app_list_strings['scrm_partners_type_dom']['Press'] = 'Пресса';
$app_list_strings['scrm_partners_type_dom']['Prospect'] = 'Адресат';
$app_list_strings['scrm_partners_type_dom']['Reseller'] = 'Реселлер';
$app_list_strings['scrm_partners_type_dom']['Other'] = 'Другое';
