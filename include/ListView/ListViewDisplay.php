...
class ListViewDisplay {
	...
	protected function buildActionMenus($data){
		...
		//echo 
		$link="index.php?module=$module&offset=1&return_module=$module&action=EditView&record=|DATA|";
		//echo "<br>";
        ...
        if ( ACLController::checkAccess($this->seed->module_dir,'edit',true)){
        	...
        	$menu.="<li><a id='|DATA|' href='$link' ><i class='fa fa-edit'></i>&nbsp;{$app_strings['LNK_EDIT']}</a></li>";
    	}
    	
    	if ( ACLController::checkAccess($this->seed->module_dir,'delete',true)){

    		$menu.="<li><a id='|DATA|' onclick=\"javascript:DeleteRecord('|DATA|','$module','delete');\"><i class='fa fa-trash'></i>&nbsp;{$app_strings['LNK_DELETE']}</a></li>";
    	}

    	

    	// $menu.="<li><a id='' href=''><i class='fa fa-phone'></i>'{$app_strings['LBL_SCHEDULE_CALL']}</a></li>";

    	// $menu.="<li><a id='' href=''><i class='fa fa-users'></i>'{$app_strings['LBL_SCHEDULE_MEETING']}</a></li>";

    	// $menu.="<li><a id='' href=''><i class='fa fa-tasks'></i>'{$app_strings['LBL_ADD_TO_DO']}</a></li>";
	...
	protected function buildActionsLink($id = 'actions_link', $location = 'top')
	{
		...
		$menuItems = array();
			...
			$menuItems[] = "<a href='javascript:void(0)'>Actions</a>";
	...
	{
		global $app_strings;
        return "<a href='javascript:void(0)' id=\"delete_listview_". $loc ."\" onclick=\"return sListView.send_mass_update('selected', '{$app_strings['LBL_LISTVIEW_NO_SELECTED']}', 1)\">Delete</a>";
		//this is the part of action button {$app_strings['LBL_DELETE_BUTTON_LABEL']}
