...
*}
{*
	its coming from ListViewSmarty.php
	{$sugarconfig|@print_r}
*}
<script>
{literal}
...
{/literal}
  ...
  <!-- <link href="themes/simplecrm/css/new1/style_new.css" rel="stylesheet" type="text/css" /> -->
...
{if $hideTable == false}
	...
	<table cellpadding='0' cellspacing='0' width='100%' border='0' class='list table'>

	<!-- <table cellpadding='0' cellspacing='0' width='100%' border='0' class="test"> -->
	...
	<tr height='20'>
		...
		{foreach name=rowIteration from=$data key=id item=rowData}
			...
			<tr height='20' class='{$_rowColor}S1'>
               ...
               <!--  <ul id="menu-lateral" class="menu1">
					<li id="menu-item-29"><a href="#"><i aria-hidden="true" class="fa fa-gear"></i></a>
						<ul class="sub-menu">
			<li id="menu-item-108">
			<a id="edit-{$rowData.ID}" href="index.php?module={$linkModule}&offset={$offset}&stamp={$pageData.stamp}&return_module={$linkModule}&action={$action}&record={$rowData.ID}"><i aria-hidden="true" class="fa fa-edit"></i>Edit</a>
			</li>
				<li id="menu-item-108"><a id="1" href="#"><i aria-hidden="true" class="fa fa-trash"></i>Delete</a>
			</li>
		</ul>
	</li>
</ul> -->
			...
			<a href="#" data-toggle="dropdown" class="toggle" title="Action"><i aria-hidden="true" class="fa fa-gear"   style="cursor:pointer"></i></a>

			 <ul class="dropdown-menu animated fadeIn">
        		<li><a id="edit-{$rowData.ID}" href="index.php?module={$linkModule}&offset={$offset}&stamp={$pageData.stamp}&return_module={$linkModule}&action={$action}&record={$rowData.ID}"><i aria-hidden="true" class="fa fa-edit"></i>Edit</a></li>
         		<li><a href="#"><i aria-hidden="true" class="fa fa-trash"></i>Delete</a></li>
    		</ul>
    		</div>
...
$(this).siblings('.sub-menu').slideToggle('fadeIn');
});{/literal}
</script>
