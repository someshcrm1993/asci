...
class ListViewSmarty extends ListViewDisplay{
	...
	function process($file, $data, $htmlVar) {
        ...
        // echo "<pre>";
        // print_r($this->displayColumns);exit;
        //  echo "</pre>";
		...
		$this->ss->assign('sugarconfig', $this->displayColumns);
         //~ echo "<pre>";
         //~ print_r($this->data['pageData']['idIndex']);
        // echo $this->sugarconfig;exit;
        //  echo "</pre>";
        ...
        //print_r($this->data['pageData']['offsets']);

        //echo count($this->data['data'];
        //foreach($this->data['pageData']['idIndex'] as $key=>$value){
