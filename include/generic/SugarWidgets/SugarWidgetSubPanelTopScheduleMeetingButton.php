...
class SugarWidgetSubPanelTopScheduleMeetingButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
	function &_get_form($defines, $additionalFormFields = null)
	{
		...
		//module_button is used to override the value of module name
			//~ $button .= "<input id='Activities_schedulemeeting_button' accesskey name='Activities_schedulemeeting_button' class='button action_button_right_panel' type='submit' value='Schedule Meeting' data-toggle='modal' data-target='#myModalcustom_popup'
		//~ />";
