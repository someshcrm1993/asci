    ...
    )
{
    ...
    $is_min_max = strpos($other_text,"_custom.png");
    if($is_min_max !== false)
...
<tr>
<td nowrap><h3><span class="change_color_dashlets">{$form_title}</span></h3></td>
EOHTML;
}else
{

$the_form .= <<<EOHTML
<div nowrap><span class="change_color_dashlets" style="font-size:14px"><a href="javascript:void(0)">{$form_title}</a></span></div>
EOHTML;
}
...
{
           $the_form .= <<<EOHTML
<IMG height='1' width='1' src='$blankImageURL' alt=''>
