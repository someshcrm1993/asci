...
<tr>
	...
	<td width='30%' nowrap>
		...
		<button title='{$APP.LBL_SAVE_BUTTON_LABEL}' value='{$APP.LBL_SAVE_BUTTON_LABEL}' class='button btn btn-outline-primary' type='button' name='saved_search_submit' onclick='SUGAR.savedViews.setChooser(); return SUGAR.savedViews.saved_search_action("save");'><i class="fa fa-floppy-o fa-lg btn-color-new" aria-hidden="true" ></i></button>
		*}
	...
	<td width='30%' nowrap>
        {*<button class='button btn btn-outline-primary' onclick='SUGAR.savedViews.setChooser(); return SUGAR.savedViews.saved_search_action("update")' value='{$APP.LBL_UPDATE}' title='{$APP.LBL_UPDATE}' name='ss_update' id='ss_update' type='button' ><i class="fa fa-refresh fa-lg" aria-hidden="true" style="color:#2382D5"></i></button>
...
<tr>
	<td colspan='5'>
        <button tabindex='2' title='{$APP.LBL_SEARCH_BUTTON_TITLE}' onclick='SUGAR.savedViews.setChooser()' class='button btn btn-outline-primary' type='submit' name='button' {*value='{$APP.LBL_SEARCH_BUTTON_LABEL}'*} id='search_form_submit_advanced'><i class="fa fa-search fa-lg btn-color-new" aria-hidden="true" ></i></button>&nbsp;
        ...
        _advanced' {*value='{$APP.LBL_CLEAR_BUTTON_LABEL}'*}><i class="fa fa-times fa-lg btn-color-new" aria-hidden="true" ></i></button>
        ...
        *}
        ...
        {/if}
        <button id="basic_search_link" type="button" class='button btn btn-outline-primary' onclick="SUGAR.searchForm.searchFormSelect('{$module}|basic_search','{$module}|advanced_search')"  accesskey="{$APP.LBL_ADV_SEARCH_LNK_KEY}" title="{$APP.LNK_BASIC_SEARCH}"><i class="fa fa-filter fa-lg btn-color-new" aria-hidden="true" ></i>
</button>
		...
		*}
        ...
        <button class='button btn btn-outline-primary' onclick='SUGAR.savedViews.setChooser(); return SUGAR.savedViews.saved_search_action("update")' {*value='{$APP.LBL_UPDATE}'*} title='{$APP.LBL_UPDATE}' name='ss_update' id='ss_update' type='button' ><i class="fa fa-refresh fa-lg btn-color-new" aria-hidden="true" ></i></button>
		<button class='button btn btn-outline-primary' onclick='return SUGAR.savedViews.saved_search_action("delete", "{sugar_translate label='LBL_DELETE_CONFIRM' module='SavedSearch'}")' {*value='{$APP.LBL_DELETE}'*} title='{$APP.LBL_DELETE}' name='ss_delete' id='ss_delete' type='button'><i class="fa fa-trash fa-lg btn-color-new" aria-hidden="true" ></i>
</button>
