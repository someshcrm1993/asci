        ...
        array (
          ...
          array (
            ...
            array (
             ...
             array (
              'customCode' => '<input  type="submit" class="button" name="create" id="create" value="Create Target" onClick="document.location=\'index.php?module=Prospects&action=EditView&return_module=Prospects&return_action=DetailView\'">',
            ),
        ),
        'hidden' => 
        array (
