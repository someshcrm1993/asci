...
$mod_strings = array(
    ...
    'ERR_USER_IS_LOCKED_OUT' => 'This user is locked out of the SimpleCRM application and cannot log in using his/her existing password.',
    ...
    'LBL_GROUP_DESC' => 'Use for assigning items to a group (example: for Inbound Email).  This type cannot login through the SimpleCRM web interface.',
    ...
    'LBL_PHONE' => 'Phone',
    'LBL_PICK_TZ_WELCOME' => 'Welcome to SimpleCRM.',
    ...
    'LBL_PORTAL_ONLY_DESC' => 'Use for the Portal API. This type cannot login through the SimpleCRM web interface.',
    ...
    'LBL_REMINDER_TEXT' => 'Set a default for reminders for calls and meetings. Pop-up notifications appear for all invitees using SimpleCRM. Email reminders are sent to all invitees.',
    ...
    'LBL_SETTINGS_URL_DESC' => 'Use this URL when establishing login settings for the SimpleCRM Plug-in for Microsoft&reg; Outlook&reg; and the SimpleCRM Plug-in for Microsoft&reg; Word&reg;.',
    ...
    'LBL_SUGAR_LOGIN' => 'Is SimpleCRM User',
    ...
    'LBL_ICAL_PUB_URL_HELP' => 'Use this URL to subscribe to the SimpleCRM calendar within iCal.',
...
// PROJECT RESOURCES STRINGS
    ...
    'LBL_WIZARD_WELCOME' => 'Click <b>Next</b> to configure a few basic settings for using SimpleCRM.',
    'LBL_WIZARD_WELCOME_NOSMTP' => 'Click <b>Next</b> to configure a few basic settings for using SimpleCRM.',
    ...
    'LBL_WIZARD_FINISH_TITLE' => 'You are ready to use SimpleCRM!',

    'LBL_WIZARD_FINISH' => 'Click <b>Finish</b> below to save your settings and to begin using SimpleCRM. For more information on using SimpleCRM:<br /><br />
<table cellpadding=0 cellspacing=0>
<tr><td><!--not_in_theme!-->Visit www.simplecrm.com <img src=include/images/simplecrm_login.png style="margin-right: 5px;"></td><td><a href="http://www.simplecrm.com/" target="_blank"><b>SimpleCRM</b></a></td></tr>
</table>',

    'LBL_WIZARD_FINISH1' => 'What would you like to do next?',
    'LBL_WIZARD_FINISH2' => 'Start Using SimpleCRM',
    ...
    'LBL_WIZARD_FINISH11' => 'Visit SimpleCRM Site ',
    ...
    'LBL_WIZARD_FINISH17' => 'Tips from SimpleCRM',
    'LBL_WIZARD_FINISH18' => 'Forums ',
    'LBL_WIZARD_FINISH19' => 'Forums dedicated to the SimpleCRM Community to discuss topics of interest with each other and with SimpleCRM Developers ',
    ...
    'LBL_WIZARD_PERSONALINFO_DESC' => 'Provide information about yourself. The information you provide about yourself will be visible to other SimpleCRM users.<br />Fields marked with <span class="required">*</span> are required.',
    'LBL_WIZARD_LOCALE_DESC' => 'Specify your time zone and how you would like dates, currencies and names to appear in SimpleCRM.',
    ...
    'LBL_SUITE_SUPERCHARGED' => "Supercharged by SimpleCRM",
    'LBL_SUITE_POWERED_BY' => "Powered By SugarCRM",
    'LBL_SUITE_TOP' => "Back to top",
    'LBL_SUITE_PRINT' => "Print this page",
    'LBL_SUITE_DESC1' => 'SimpleCRM has been written and assembled by SalesAgility, one of the worlds most knowledgeable SugarCRM consultancies.',
    'LBL_SUITE_DESC2' => 'SimpleCRM is intended to deliver on the promise of SugarCRM - a freely available open source CRM project that combines great functionality, with community and commitment.',
