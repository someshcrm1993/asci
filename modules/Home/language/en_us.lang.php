 ...
 * SimpleCRM is an extension to SugarCRM Community Edition developed by Salesagility Ltd.
 ...
 * SugarCRM" logo and "Supercharged by SimpleCRM" logo. If the display of the logos is not
 * reasonably feasible for  technical reasons, the Appropriate Legal Notices must
 * display the words  "Powered by SugarCRM" and "Supercharged by SimpleCRM".
 ********************************************************************************/
...
$mod_strings  = array(
	...
	'LBL_RGraph_REGION_FORM_TITLE'=>'Region Wise Sales in India',
	'LBL_WORLD_WISE_FORM_TITLE'=>'World Wide Sales',
	'LBL_ASIA_FORM_TITLE'=>'Asia Pacific Sales',
	'LBL_EUROPE_FORM_TITLE'=>'Europe Sales',
	'LBL_PERFORMANCE_FORM_TITLE'=>'My Current Quarter Performance',
  ...
  'LBL_RELOAD_PAGE' => 'Please <a href="javascript: window.location.reload()">reload the window</a> to use this SimpleCRM Dashlet.',
  'LBL_ADD_DASHLETS' => 'Add SimpleCRM Dashlets',
  ...
  'LBL_MAX_DASHLETS_REACHED' => 'You have reached the maximum number of SimpleCRM Dashlets your administrator has set. Please remove a SimpleCRM Dashlet to add a new one.',
  'LBL_ADDING_DASHLET' => 'Adding SimpleCRM Dashlet ...',
  'LBL_ADDED_DASHLET' => 'SimpleCRM Dashlet Added',
  'LBL_REMOVE_DASHLET_CONFIRM' => 'Are you sure you want to remove this SimpleCRM Dashlet?',
  'LBL_REMOVING_DASHLET' => 'Removing SimpleCRM Dashlet ...',
  'LBL_REMOVED_DASHLET' => 'SimpleCRM Dashlet Removed',
  ...
  'LBL_DASHLET_DELETE' => 'Delete SimpleCRM Dashlet',
  'LBL_DASHLET_REFRESH' => 'Refresh SimpleCRM Dashlet',
  'LBL_DASHLET_EDIT' => 'Edit SimpleCRM Dashlet',

    'LBL_TRAINING_TITLE' => 'Training',

  'LBL_CREATING_NEW_PAGE' => 'Creating New Page...',
  'LBL_NEW_PAGE_FEEDBACK' => 'You have created a new page. You can add new content with the Add SimpleCRM Dashlets option.',
  ...
  'LBL_HOME_PAGE_1_NAME' => 'My SimpleCRM',
  ...
  'LBL_DASHLET_SEARCH' => 'Find SimpleCRM Dashlet',
...
//ABOUT page
  ...
  'LBL_JOIN_SUGAR_COMMUNITY' => 'Join the SimpleCRM Community',
  'LBL_DETAILS_SUGARFORGE' => 'Collaborate and develop SimpleCRM extensions',
  'LBL_DETAILS_SUGAREXCHANGE' => 'Buy and sell certified SimpleCRM extensions',
  'LBL_TRAINING' => 'Training',
  'LBL_DETAILS_TRAINING' => 'Learn about SimpleCRM using online and interactive learning content',
  'LBL_FORUMS' => 'Forums',
  'LBL_DETAILS_FORUMS' => 'Discuss SimpleCRM with expert community users and developers',
  'LBL_WIKI' => 'Wiki',
  'LBL_DETAILS_WIKI' => 'Search the knowledge base of user and developer topics',
  'LBL_DEVSITE' => 'Developer Site',
  'LBL_DETAILS_DEVSITE' => 'Discover resources, tutorials, and helpful links to get you up to speed on SimpleCRM development',
 'LBL_GET_SUGARCRM_RSS' => 'Get SimpleCRM RSS',
  'LBL_SUGARCRM_NEWS' => 'SimpleCRM News',
  'LBL_SUGARCRM_TRAINING_NEWS' => 'SimpleCRM Training News',
  'LBL_SUGARCRM_FORUMS' => 'SimpleCRM Forums',
  'LBL_SUGARFORGE_NEWS' => 'SimpleCRM News',
  ...
  'LBL_DASHLET_SUGAR_NEWS' => 'SimpleCRM News',
  'LBL_DASHLET_DISCOVER_SUGAR_PRO' => 'Discover SimpleCRM',
    ...
    'LBL_TOUR_NOTIFICATIONS_DESCRIPTION' => 'SimpleCRM application notifications would go here.',
    ...
    'LBL_TOUR_WELCOME' => 'Welcome to SimpleCRM',
    'LBL_TOUR_WATCH' => 'Watch What\'s New in SimpleCRM',
    ...
    'LBL_TOUR_CALENDAR_URL_1' => 'Do you share your SimpleCRM calendar with 3rd party applications, such as Microsoft Outlook or Exchange? If so, you have a new URL. This new, more secure URL includes a personal key which will prevent unauthorized publishing of your calendar.',
    'LBL_TOUR_CALENDAR_URL_2' => 'Retrieve your new shared calendar URL.',
    'LBL_ABOUT' => 'About',
    'LBL_CONTRIBUTORS' => 'Contributors',
    'LBL_ABOUT_SUITE' => 'About SimpleCRM',
    'LBL_PARTNERS' => 'Partners',
    'LBL_FEATURING' => 'AOS, AOW, AOR, AOP, AOE and Reschedule modules by SalesAgility.',

    'LBL_CONTRIBUTOR_SUITECRM' => 'SimpleCRM - Open source CRM for the world',
    ...
    'LBL_CONTRIBUTOR_CONSCIOUS' => 'SimpleCRM LOGO Provided by Conscious Solutions',
    'LBL_CONTRIBUTOR_RESPONSETAP' => 'Contribution to SimpleCRM 7.3 release by ResponseTap',


    'LBL_LANGUAGE_SPANISH' => 'Spanish Translation Provided by Disytel openConsulting',

    'LBL_ABOUT_SUITE_1' => 'SimpleCRM is a fork of SugarCRM. There are many articles on the web that explain the reasons why a fork of SugarCRM became necessary.',
    'LBL_ABOUT_SUITE_2' => 'SimpleCRM is published under an open source licence - GPL3',
    'LBL_ABOUT_SUITE_3' => 'SimpleCRM is completely compatible with SugarCRM 6.5.x',
    'LBL_ABOUT_SUITE_4' => 'All SimpleCRM code managed and developed by the project will be released as open source - GPL3',
    'LBL_ABOUT_SUITE_5' => 'SimpleCRM support is available in both free and paid-for options',

    'LBL_SUITE_PARTNERS' => 'We have loyal SimpleCRM partners who are passionate about open source. To view our full partner list, see our website.',
