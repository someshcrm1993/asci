    ...
    array (
      ...
      array (
        ...
        array (
          ...
          //~ array (
              //~ 'customCode' => '<input  type="submit" class="button" name="create" id="create" value="Create Employee" onClick="document.location=\'index.php?module=Employees&action=EditView&return_module=Employees&return_action=DetailView\'">',
            //~ ),
        ),
      ),
      'maxColumns' => '2',
