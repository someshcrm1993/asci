...
$mod_strings = array (
  ...
  'LBL_EMAIL_LINK_TYPE_HELP'			=> '<b>SimpleCRM Mail Client:</b> Send emails using the email client in the SimpleCRM application.<br><b>External Mail Client:</b> Send email using an email client outside of the SimpleCRM application, such as Microsoft Outlook.',
