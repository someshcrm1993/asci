            ...
            <tr>
                ...
                <td>
                    <div id="parameterOptions{$id}">
                        ...
                        {elseif $condition.value_type == "Multi"}
                                      {$condition.module_display} - <em>{$condition.field_display}</em> - {$condition.operator_display}
                                      <select id="parameter_value[0]" name="parameter_value[0][]" multiple="true" size="6" style="width:150" title="" tabindex="1">
                                           {html_options options=$enum_list selected=$condition.value}
