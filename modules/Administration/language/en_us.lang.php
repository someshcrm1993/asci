...
$mod_strings = array(
    ...
    'ERR_CREDENTIALS_MISSING' => 'Your SimpleCRM credentials are missing.',
    ...
    'ERROR_FLAVOR_INCOMPATIBLE' => 'The uploaded file is not compatible with this version of SimpleCRM: ',
    ...
    'HDR_LOGIN_PANEL' => 'Please enter your SimpleCRM Login credentials.',
    'HEARTBEAT_MESSAGE' => "<BR>The SimpleCRM Updates mechanism allows your server to check to see if an update for your version of SimpleCRM is available.",
    'LBL_ACCEPT_TERMS' => 'Accept Terms and Conditions',
    'LBL_ACCEPT' => 'Accept',
    'LBL_ADMIN_SUGAR_SERVER' => 'Admin User Name:',
    'LBL_ADMIN_WIZARD_TITLE' => 'Admin Wizard',
    'LBL_ADMIN_WIZARD' => 'Easily setup your SimpleCRM system',
    ...
    'LBL_BACKUP_DIRECTORY_WRITABLE' => 'Must be writable by SimpleCRM',
    ...
    'LBL_BACKUP_INSTRUCTIONS_1' => 'The purpose of this tool is to assist in creating backups of the SimpleCRM application files. (Database backups should also be performed regularly. Please refer to your database vendor\'s documentation for information on how to backup your database.)',
    'LBL_BACKUP_INSTRUCTIONS_2' => 'To backup your SimpleCRM application files in a .zip file, enter the following information:',
    'LBL_BACKUP_RUN_BACKUP' => 'Run Backup',
    'LBL_BACKUP_TITLE' => 'Online Backups',
    'LBL_BACKUP' => 'Schedule backups to the SimpleCRM Online Data Vault.  Activate a system restoration from backup.',
    'LBL_BACKUPS_TITLE' => 'Backups',
    'LBL_BACKUPS' => 'Backup SimpleCRM files',
    'LBL_BROWSE' => 'Browse',
    'LBL_BUG_TITLE' => 'Bugs',
    ...
    'LBL_CONFIGURE_UPDATER' => 'Configure SimpleCRM Updates',
    ...
    'LBL_COULD_NOT_CONNECT' => 'Error: Could not connect to the SimpleCRM Server.
    ...
    'LBL_DIAGNOSTIC_CONFIGPHP' => 'SimpleCRM config.php',
    'LBL_DIAGNOSTIC_CUSTOMDIR' => 'SimpleCRM Custom directory',
    ...
    'LBL_DIAGNOSTIC_GETSUGARLOG' => 'Getting simplecrm.log',
    ...
    'LBL_DIAGNOSTIC_SUGARLOG' => 'SimpleCRM Log File',
    'LBL_DIAGNOSTIC_TITLE' => 'Diagnostic Tool',
    'LBL_DIAGNOSTIC_VARDEFS' => 'SimpleCRM schema output (VARDEFS)',
    ...
    'LBL_DOCUMENTATION' => 'View SimpleCRM documentation for administrators and end-users',
    'LBL_DONE' => 'Done',
    ...
    'LBL_LDAP_HELP_TXT' => 'When LDAP authentication is enabled, passwords can only be handled through LDAP. None of the SimpleCRM Password Management feature settings will apply.',
    'LBL_LDAP_SERVER_HOSTNAME' => 'Server:',
    'LBL_LDAP_SERVER_PORT' => 'Port Number:',
    'LBL_LDAP_ADMIN_USER' => 'User Name:',
    'LBL_LDAP_ADMIN_USER_DESC' => 'Used to search for the SimpleCRM user. [May need to be fully qualified] It will bind anonymously if not provided.',
    ...
    'LBL_LDAP_GROUP_NAME_DESC' => 'Example cn=SimpleCRM',
    'LBL_LDAP_USER_DN_DESC' => 'Example: ou=people,dc=example,dc=com',
    'LBL_LDAP_AUTO_CREATE_USERS_DESC' => 'If an authenticated user does not exist one will be created in SimpleCRM.',
    ...
    'LBL_MASSAGE_MASS_EMAIL_DESC' => 'SimpleCRM requires an update to the Mass Email data.  Click "Begin Update" to continue.',
    ...
    'LBL_MI_IN_DASHLETS' => 'Installing SimpleCRM Dashlet ',
    'LBL_MI_UN_DASHLETS' => 'Uninstalling SimpleCRM Dashlet ',
    ...
    'LBL_MODULE_LOADER' => 'Add or remove SimpleCRM modules, themes, language packs and other extensions',
    ...
    'LBL_OFFLINE_CLIENT' => 'View Offline Clients that are connected to this SimpleCRM system',
    ...
    'LBL_PLUGINS' => 'Get plug-ins and other SimpleCRM extensions.',
    ...
    'LBL_PROXY_ON_DESC' => 'Use a proxy to access external information such as SimpleCRM updates.',
    ...
    'LBL_REBUILD_DASHLETS_DESC_SHORT' => 'Rebuilds the SimpleCRM Dashlets cache file',
    'LBL_REBUILD_DASHLETS_DESC_SUCCESS' => 'SimpleCRM Dashlets cache file rebuilt.',
    'LBL_REBUILD_DASHLETS_DESC' => 'Removing SimpleCRM Dashlets cache and scanning known directories for SimpleCRM Dashlet files.',
    'LBL_REBUILD_DASHLETS_TITLE' => 'Rebuild SimpleCRM Dashlets',
...
//BEGIN SUGARCRM flav=een
    'LBL_REBUILD_EXPRESSIONS_DESC' => 'Rebuilds SimpleCRM Logic functions cache',
    'LBL_REBUILD_EXPRESSIONS_TITLE' => 'Rebuild SimpleCRM Logic Functions',
//END SUGARCRM flav=een
    ...
    'LBL_REPAIR_ORACLE_VARCHAR_DESC_LONG_1' => 'The following queries should be run against your database.  Run them manually with the client of your choice or click the "Commit" button to have SimpleCRM run the queries immediately.',
    ...
    'LBL_SEND_STAT' => '<B>Send Anonymous Usage Statistics</B> - If checked, it will send anonymous statistics about your installation to SimpleCRM. every time your system checks for new versions.  This information will help us better understand how the application is used and guide improvements to the product.',
    ...
    'LBL_STUDIO' => 'Studio',
    'LBL_SUGAR_NETWORK_TITLE' => 'SimpleCRM Connect',
    'LBL_SUGAR_NETWORK_DESC' => 'Connect to the various SimpleCRM services where you can access the SimpleCRM forums and SimpleCRM Wiki, search FAQs (Frequently Asked Questions), download the latest SimpleCRM version, file and research reported bugs and request new features and more.',
    'LBL_SUGAR_SCHEDULER_TITLE' => 'Scheduler',
    'LBL_SUGAR_SCHEDULER' => 'Set up scheduled events',
    'LBL_SUGAR_SERVER_URL_DESC' => '- The URL of the server this client will connect to (e.g., http://localhost/simplecrmserver).',
    'LBL_SUGAR_SERVER_URL' => 'Server URL:',
    'LBL_SUGAR_UPDATE_TITLE' => 'SimpleCRM Updates',
    'LBL_SUGAR_UPDATE' => 'Check for the latest SimpleCRM version',
    'LBL_SUGARCRM_HELP' => 'SimpleCRM Help',
    'LBL_SUPPORT_TITLE' => 'SimpleCRM Support Portal',
    ...
    'LBL_UPDATE_TITLE' => 'SimpleCRM Updates',
    ...
    'LBL_UPGRADE_CONVERT_DISC_CLIENT' => 'Convert this SimpleCRM installation to an Offline Client',
    ...
    'LBL_UPGRADE_WIZARD' => 'Upload and install SimpleCRM upgrades',
    'LBL_UPGRADE' => 'Check and repair SimpleCRM',
    ...
    'LBL_USERS_DESC' => 'Create, edit, activate and deactivate users in SimpleCRM.',
    ...
    'LBL_MODULEBUILDER_DESC' => 'Build new modules to expand the functionality of SimpleCRM',
    'LBL_SUGARPORTAL' => 'SimpleCRM Portal',
    'LBL_SUGARPORTAL_DESC' => 'Manage the SimpleCRM Portal',
    ...
    'LBL_QUICK_REPAIR_AND_REBUILD_DESC' => 'Repairs and rebuilds DB, Extensions, Vardefs, SimpleCRM Dashlets etc.',
    ...
    'LBL_QR_CBOX_CLEARDASHLET' => 'Clear SimpleCRM Dashlet Cache Data',
    ...
    'LBL_QR_CLEARDASHLET' => 'Clearing SimpleCRM Dashlet files from cache...done',
    ...
    'LBL_QR_CBOX_CLEARSUGARFEEDCACHE' => 'Clear SimpleCRM Feed Cache',
    'LBL_QR_CLEARSUGARFEEDCACHE' => 'Clearing SimpleCRM Feed Cache...done',
    ...
    'ML_RELAX_LOCAL' => 'If you are running SimpleCRM locally, you can relax your Module Loader restrictions to allow the package to be installed.',
    'ML_SUGAR_KB' => 'SimpleCRM Knowledge Base',
    'ML_SUGAR_DZ' => 'SimpleCRM Developer Zone',
    'ML_AVAIL_RESTRICTION' => 'The available restrictions and exceptions are detailed in the',
    'ML_OVERRIDE_CORE_FILES' => 'Overriding of core SimpleCRM files is not allowed ',
    ...
    'LBL_SAML_HELP_TXT' => 'When SAML authentication is enabled, passwords can only be handled through SAML. None of the SimpleCRM Password Management feature settings will apply.',
    ...
    'LBL_EAPM_SETTINGS_DESC' => 'Select external applications for which users can provide their account information in order to access from within SimpleCRM.',
    ...
    'LBL_CONFIGURE_SNIP_DESC' => 'Enable/disable the SimpleCRM Email Archiving Service',
    ...
    'LBL_FTS_HOST' => 'Host',
    'LBL_FTS_PORT' => 'Port',
    'LBL_FTS_TYPE_HELP' => 'Select the engine to use for full text searching. The system detects the engines that are supported and displays them within this list. SimpleCRM includes built-in support for the elasticsearch engine.',
...
3) Click Test to make sure SimpleCRM can connect to the search engine<br>
4) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
    ...
    'LBL_COLOUR_DESC' => 'Customise your SimpleCRM theme to match your branding.',
    'LBL_COLOUR_ADMIN_INTRO' => 'Change these settings to customise your SimpleCRM theme. <strong>Note:</strong> Please remember to refresh (Ctrl + F5) once you have saved your settings.',
    ...
    'LBL_SECURITYGROUPS_SUGAROUTFITTERS' => "Grab the latest version of SecuritySuite and find other SimpleCRM modules, themes, and integrations along with reviews, docs, support, and community verified versions.",
