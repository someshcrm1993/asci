...
$yester_day = date("l",strtotime("-1 days"));
$backup = "squarefoot"."_".$yester_day."_".$yesterdayDate.".zip";

$downLink = 'http://dailybackup.simplecrmondemand.com/'.$backup;

//Source Code
$admin_option_defs=array();

$admin_option_defs['Administration']['sourcecode']= array('download_image','Download','Download Source Code here','');

$admin_option_defs['Administration']['sourcecode_dup']= array('','','','');

//Source Code void
$admin_group_header[]= array('Source Code','',false,$admin_option_defs, '');
