 ...
 * PLACE ANY CUSTOMIZATIONS IN scrm_Travel_Details
 */

require_once('include/SugarObjects/templates/person/Person.php');

class scrm_Travel_Details_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'scrm_Travel_Details';
	var $object_name = 'scrm_Travel_Details';
	var $table_name = 'scrm_travel_details';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function scrm_Travel_Details_sugar(){	
		parent::Person();
	}
