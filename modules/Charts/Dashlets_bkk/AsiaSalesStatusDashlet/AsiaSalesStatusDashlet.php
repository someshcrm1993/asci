...
class AsiaSalesStatusDashlet extends DashletGenericChart
{
    ...
    )
    {
        ...
        if(empty($options['title']))
            $options['title'] = translate('LBL_ASIA_FORM_TITLE', 'Home');
 ...
 $chart = <<<EOD
    ...
    <script type="text/javascript">
      ...
      //google.charts.setOnLoadCallback(drawAsiaMap);
      ...
      function drawAsiaMap() {		
		...
		var asiachart = new google.visualization.GeoChart(document.getElementById('asiapacificchart-colors'));
        asiachart.draw(chartdata, options);               
      ...
      <body>
		<div id="asiapacificchart-colors" style="width: 100%; height: 433px; align=center;"></div>
	  </body>
EOD;
        return $chart;
    }
