...
class EuropeSalesStatusDashlet extends DashletGenericChart
{
    ...
    )
    {
        ...
        if(empty($options['title']))
            $options['title'] = translate('LBL_EUROPE_FORM_TITLE', 'Home');
 ...
 $chart = <<<EOD
    ...
    <script type="text/javascript">
      ...
      function drawEuropeMap() {		
		...
		var europechart = new google.visualization.GeoChart(document.getElementById('europechart-colors'));
        europechart.draw(chartdata, options);
      ...
      <body>
		<div id="europechart-colors" style="width: 100%; height: 433px; align=center;"></div>
	  </body>
EOD;
        return $chart;
    }
