...
//~ google.charts.setOnLoadCallback(drawMultSeries);
	...
	//~ var jsondata = $jsonData;
      //~ var jsonlabels = $jsonLabels;
	//~ 
	//~ data1=new Object();
						 //~ data1['Prospecting'] = jsondata[0];
						 //~ data1['Qualification'] = jsondata[1];
						 //~ data1['Needs_Analysis'] = jsondata[2];
						 //~ data1['Value_Proposition'] = jsondata[3];
						 //~ data1['Id_Decision_Makers'] = jsondata[4];
						 //~ data1['Perception_Analysis'] = jsondata[5];
						 //~ data1['Proposal_Price_Quote'] = jsondata[6];
						 //~ data1['Negotiation_Review'] = jsondata[7];
						 //~ 
      //~ var data = google.visualization.arrayToDataTable([
							//~ ['Sales Stage', 'Amount in US Dollars', { role:"style"}],
							//~ ['Prospecting', data1['Prospecting'],"color: #5bc0de"],
							//~ ['Qualification', data1['Qualification'],"color: #428bca"],
							//~ ['Needs Analysis', data1['Needs_Analysis'],"color: #d9534f"],
							//~ ['Value Proposition', data1['Value_Proposition'],"color: #5cb85c"],
							//~ ['Id. Decision Makers', data1['Id_Decision_Makers'],"color: #f0ad4e"],
							//~ ['Perception Analysis', data1['Perception_Analysis'],"color: #5bc0de"],
							//~ ['Proposal/Price Quote', data1['Proposal_Price_Quote'],"color: #d9534f"],
							//~ ['Negotiation/Review', data1['Negotiation_Review'],"color: #5cb85c"],
      //~ ]);
//~ 
      //~ var options = {
        //~ title: 'My Pipeline Sales Stages',
        //~ chartArea: {width: '50%'},
        //~ hAxis: {
          //~ title: 'Amount',
          //~ minValue: 0
