 ...
 * PLACE ANY CUSTOMIZATIONS IN scrm_Service_Providers
 */

require_once('include/SugarObjects/templates/person/Person.php');

class scrm_Service_Providers_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'scrm_Service_Providers';
	var $object_name = 'scrm_Service_Providers';
	var $table_name = 'scrm_service_providers';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function scrm_Service_Providers_sugar(){	
		parent::Person();
	}
