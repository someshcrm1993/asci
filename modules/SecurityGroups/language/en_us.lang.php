...
$mod_strings = array (
  ...
  'LBL_INHERIT_CREATOR_DESC' => 'The record will inherit the primary groups assigned to the user who created it.',
  ...
  'LBL_INHERIT_ASSIGNED_DESC' => 'The record will inherit the primary groups of the user assigned to the record. Other groups assigned to the record will NOT be removed.',
