 ...
 * PLACE ANY CUSTOMIZATIONS IN scrm_Accommodation
 */

require_once('include/SugarObjects/templates/person/Person.php');

class scrm_Accommodation_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'scrm_Accommodation';
	var $object_name = 'scrm_Accommodation';
	var $table_name = 'scrm_accommodation';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function scrm_Accommodation_sugar(){	
		parent::Person();
	}
