            ...
            array (
                ...
                array (
                    ...
                    array (
                        ...
                        2 => 'DELETE',
                        array (
              'customCode' => '<input  type="submit" class="button" name="create" id="create" value="Create PDF Template" onClick="document.location=\'index.php?module=AOS_PDF_Templates&action=EditView&return_module=AOS_PDF_Templates&return_action=DetailView\'">',
            ),
                    ),
                ),
                'maxColumns' => '2',
