...
array (
              'customCode' => '<input  type="submit" class="button" name="create" id="create" value="Create Target List" onClick="document.location=\'index.php?module=ProspectLists&action=EditView&return_module=ProspectLists&return_action=DetailView\'">',
            ),)),
