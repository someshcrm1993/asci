...
$mod_strings = array(
    ...
    'help' => array(
        ...
        'studioWizard' => array(
            ...
            'sugarPortalBtn' => 'Use <b>SimpleCRM Portal Editor</b> to manage and customize the SimpleCRM Portal.',
            ...
            'portalBtn' => 'Customize the module <b>Layouts</b> that appear in the <b>SimpleCRM Portal</b>.',
            ...
            'viewBtnDashlet' => 'Customize the module\'s <b>SimpleCRM Dashlet</b>, including the SimpleCRM Dashlet\'s ListView and Search.<br><br>The SimpleCRM Dashlet will be available to add to the pages in the Home module.',
            ...
            'dashletHelp' => 'The <b>SimpleCRM Dashlet</b> layouts that can be customized appear here.<br><br>The SimpleCRM Dashlet will be available to add to the pages in the Home module.',
            'DashletListViewBtn' => 'The <b>SimpleCRM Dashlet ListView</b> displays records based on the SimpleCRM Dashlet search filters.',
            'DashletSearchViewBtn' => 'The <b>SimpleCRM Dashlet Search</b> filters records for the SimpleCRM Dashlet listview.',
            ...
            'portalHelp' => 'Manage and customize the <b>SimpleCRM Portal</b>.',
            'SPUploadCSS' => 'Upload a <b>Style Sheet</b> for the SimpleCRM Portal.',
            'SPSync' => '<b>Sync</b> customizations to the SimpleCRM Portal instance.',
            'Layouts' => 'Customize the <b>Layouts</b> of the SimpleCRM Portal modules.',
            'portalLayoutHelp' => 'The modules within the SimpleCRM Portal appear in this area.<br><br>Select a module to edit the <b>Layouts</b>.',
        ...
        'portalSync' => array(
            'default' => 'Enter the <b>SimpleCRM Portal URL</b> of the portal instance to update, and click <b>Go</b>.<br><br>Then enter a valid SimpleCRM user name and password, and then click <b>Begin Sync</b>.<br><br>The customizations made to the SimpleCRM Portal <b>Layouts</b>, along with the <b>Style Sheet</b> if one was uploaded, will be transferred to specified the portal instance.',
        ),
        'portalStyle' => array(
            'default' => 'You can customize the look of the SimpleCRM Portal by using a style sheet.<br><br>Select a <b>Style Sheet</b> to upload.<br><br>The style sheet will be implemented in the SimpleCRM Portal the next time a sync is performed.',
        ),
    ),
    ...
    'assistantHelp' => array(
        'package' => array(
            ...
            'afterSave' => 'Your new package should contain at least one module. You can create one or more custom modules for the package.<br/><br/>Click <b>New Module</b> to create a custom module for this package.<br/><br/> After creating at least one module, you can publish or deploy the package to make it available for your instance and/or other users\' instances.<br/><br/> To deploy the package in one step within your SimpleCRM instance, click <b>Deploy</b>.<br><br>Click <b>Publish</b> to save the package as a .zip file. After the .zip file is saved to your system, use the <b>Module Loader</b> to upload and install the package within your SimpleCRM instance.  <br/><br/>You can distribute the file to other users to upload and install within their own SimpleCRM instances.',
        ...
        'module' => array(
            'somemodules' => "Since the current package contains at least one module, you can <b>Deploy</b> the modules in the package within your SimpleCRM instance or <b>Publish</b> the package to be installed in the current SimpleCRM instance or another instance using the <b>Module Loader</b>.<br/><br/>To install the package directly within your SimpleCRM instance, click <b>Deploy</b>.<br><br>To create a .zip file for the package that can be loaded and installed within the current SimpleCRM instance and other instances using the <b>Module Loader</b>, click <b>Publish</b>.<br/><br/> You can build the modules for this package in stages, and publish or deploy when you are ready to do so. <br/><br/>After publishing or deploying a package, you can make changes to the package properties and customize the modules further.  Then re-publish or re-deploy the package to apply the changes.",
...
//STUDIO2
    ...
    'LBL_SUGARPORTAL' => 'SimpleCRM Portal Editor',
    ...
    'LBL_CUSTOM' => 'Custom',
    'LBL_DASHLET' => 'SimpleCRM Dashlet',
    'LBL_DASHLETLISTVIEW' => 'SimpleCRM Dashlet ListView',
    'LBL_DASHLETSEARCH' => 'SimpleCRM Dashlet Search',
    'LBL_POPUP' => 'PopupView',
    'LBL_POPUPLIST' => 'Popup ListView',
    'LBL_POPUPLISTVIEW' => 'Popup ListView',
    'LBL_POPUPSEARCH' => 'Popup Search',
    'LBL_DASHLETSEARCHVIEW' => 'SimpleCRM Dashlet Search',
    ...
    'LBL_SUGAR_FIELDS_STAGE' => 'SimpleCRM Fields (click items to add to staging area)',
    'LBL_SUGAR_BIN_STAGE' => 'SimpleCRM Bin (click items to add to staging area)',
    'LBL_TOOLBOX' => 'Toolbox',
    'LBL_VIEW_SUGAR_FIELDS' => 'View SimpleCRM Fields',
    'LBL_VIEW_SUGAR_BIN' => 'View SimpleCRM Bin',
