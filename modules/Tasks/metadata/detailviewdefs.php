        ...
        array (
          ...
          array (
            ...
            array (
             ...
             array (
              'customCode' => '<input  type="submit" class="button" name="create" id="create" value="Create Task" onClick="document.location=\'index.php?module=Tasks&action=EditView&return_module=Tasks&return_action=DetailView\'">',
            ),
        ),
        'hidden' => 
        array (
