...
$mod_strings = array(
	...
	'ERR_UW_FLAVOR'								=> 'SimpleCRM System Flavor: ',
	'ERR_UW_LOG_FILE_UNWRITABLE'				=> './upgradeWizard.log could not be created/written to.  Please fix permissions on your SimpleCRM directory.',
	...
	'ERR_UW_MYSQL_VERSION'						=> 'SimpleCRM requires MySQL version 4.1.2 or newer.  Found: ',
	'ERR_UW_OCI8_VERSION'				        => 'Your version of Oracle is not supported by SimpleCRM.  You will need to install a version that is compatible with the SimpleCRM application.  Please consult the Compatibility Matrix in the Release Notes for supported Oracle Versions. Current version: ',
	...
	'ERR_UW_VERSION'							=> 'SimpleCRM System Version: ',
	...
	'LBL_UW_COMMIT_ADD_TASK_OVERVIEW'			=> 'Please use whichever diff method is most familiar to you to merge these files.  Until this is complete, your SimpleCRM installation will be in an uncertain state, and the upgrade incomplete.',
	'LBL_UW_COMPLETE'							=> 'Complete',
	'LBL_UW_CONTINUE_CONFIRMATION'              => 'This new version of SimpleCRM contains new license agreement.  Would you like to continue?',
	...
	'LBL_UW_START_DESC'							=> 'This wizard will assist you in upgrading this SimpleCRM instance.',
	'LBL_UW_START_DESC2'						=> 'Note: We recommend that you backup the SimpleCRM database and the system files (all of the files in the SimpleCRM folder) before upgrading your production system. We highly recommend that you perform a test upgrade on a cloned instance of your production system first.',
	...
	'LBL_UW_SUGAR_COMMUNITY_EDITION_LICENSE'    => 'The SimpleCRM Community Edition 5.0 uses GNU Affero General Public License version 3. This upgrade will convert your existing license to the new license displayed below.',
    ...
    'LBL_UW_DORP_THE_OLD_SCHMEA' 				=> 'Would you like SimpleCRM to drop the depricated 451 Schema ?',
