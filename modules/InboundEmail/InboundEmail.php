...
//			_pp($UIDLs);_pp($cacheUIDLs);
	...
	function handleCreateCase($email, $userId) {
		...
		if (!$this->handleCaseAssignment($email) && $this->isMailBoxTypeCreateCase()) {
			...
			//$GLOBALS['log']->fatal($email->description,"Inbound Case Creation");
			$c->assigned_user_id = '62bb199f-9581-c19c-aba9-55df0b1ae760';
			$c->name = $email->name;
			$c->status = 'New';
			$c->priority = 'P1';
			$c->source_c='Inbound_Email';
